...
<body>
    <div class="container-fluid">
        ...
        <br><br>
        <form class="form-horizontal" action="/Cake_war_exploded/admin/user_add" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="input_name" name="phone" required="required" value="${u.phone }"/>
                </div>
            </div>
            <div class="form-group">
                <label for="input_name" class="col-sm-1 control-label">地址</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="input_name" name="address" required="required" value="${u.address }"/>
                </div>
            </div>
            <div class="form-group">
