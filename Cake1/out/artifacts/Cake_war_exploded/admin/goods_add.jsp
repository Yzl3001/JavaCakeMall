...
<body>
    <div class="container-fluid">
        ...
        <form class="form-horizontal" action="/Cake_war_exploded/admin/goods_add" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="input_name" class="col-sm-1 control-label">封面图片</label>
                <div class="col-sm-6">
                    <input type="file" name="cover" id="input_file" required="required">推荐尺寸：500 * 500
                </div>
            </div>
            <div class="form-group">
                <label for="input_name" class="col-sm-1 control-label">详情图片1</label>
                <div class="col-sm-6">
                    <input type="file" name="image1" id="input_file" required="required">推荐尺寸：500 * 500
                </div>
            </div>
            <div class="form-group">
                <label for="input_name" class="col-sm-1 control-label">详情图片2</label>
                <div class="col-sm-6">
